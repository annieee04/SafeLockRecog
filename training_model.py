...
detector = cv2.CascadeClassifier('C://Users//anaso//PycharmProjects//SafeLockRecog//haarcascade_frontalface_default.xml')
...
faces,ids = getImagesAndLabels("C://Users//anaso//PycharmProjects//SafeLockRecog//dataset")  # Get the faces and IDs

recognizer.train(faces, np.array(ids))    # Train the model using the faces and IDs

assure_path_exists('C:\\Users\\anaso\\PycharmProjects\\SafeLockRecog\\trainer')    # Save the model into trainer.yml
recognizer.save('C:\\Users\\anaso\\PycharmProjects\\SafeLockRecog\\trainer\\trainer.yml')
