...
assure_path_exists("C:\\Users\\anaso\\PycharmProjects\\SafeLockRecog\\trainer")

recognizer.read('C:\\Users\\anaso\\PycharmProjects\\SafeLockRecog\\trainer\\trainer.yml')  # load training model

cascadePath = "C://Users//anaso//PycharmProjects//SafeLockRecog//haarcascade_frontalface_default.xml"  # cascade path
...
while True:
    ...
    if len(faces) == 0:
        ...
        for (x, y, w, h) in faces:
            ...
            if confidence > 70:  # confidence usually comes greater than 80 for strangers
                counter_wrong += 1
